...
//    hardAddLoca = view.findViewById(R.id.hard_layout);
//    hardAddLoca.setOnClickListener(new View.OnClickListener() {
//            @Override
...
////                }
//                Intent intent= new Intent(view.getContext(),AddTravelLocationActivity.class);
